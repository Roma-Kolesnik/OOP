...
//В этом примере применил магические методы __construct, __toString, __call, __invoke и __unset, полиморфизма нет
...
class Animal{
    ...
    public function setFamily($family){
        $available_families = [
            'Hare', 'Squirrel', 'Mouse', 'Felidae', 'Сanine', 'Bear'
        ];
